...
public class AdditionalSmallStairs
{
	...
	public static void init() {
		if (isExist("cut_copper")) {
			RegistryResult<Block> SMALL_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_cut_copper"), () -> Blocks.SMALL_CUT_COPPER_STAIRS);
		...
		if (isExist("exposed_cut_copper")) {
			RegistryResult<Block> SMALL_EXPOSED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_exposed_cut_copper"), () -> Blocks.SMALL_EXPOSED_CUT_COPPER_STAIRS);
		...
		if (isExist("weathered_cut_copper")) {
			RegistryResult<Block> SMALL_WEATHERED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_weathered_cut_copper"), () -> Blocks.SMALL_WEATHERED_CUT_COPPER_STAIRS);
		...
		if (isExist("oxidized_cut_copper")) {
			RegistryResult<Block> SMALL_OXIDIZED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_oxidized_cut_copper"), () -> Blocks.SMALL_OXIDIZED_CUT_COPPER_STAIRS);
		...
		if (isExist("waxed_cut_copper")) {
			RegistryResult<Block> SMALL_WAXED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_waxed_cut_copper"), () -> Blocks.SMALL_WAXED_CUT_COPPER_STAIRS);
		...
		if (isExist("waxed_exposed_cut_copper")) {
			RegistryResult<Block> SMALL_WAXED_EXPOSED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_waxed_exposed_cut_copper"), () -> Blocks.SMALL_WAXED_EXPOSED_CUT_COPPER_STAIRS);
		...
		if (isExist("waxed_weathered_cut_copper")) {
			RegistryResult<Block> SMALL_WAXED_WEATHERED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_waxed_weathered_cut_copper"), () -> Blocks.SMALL_WAXED_WEATHERED_CUT_COPPER_STAIRS);
		...
		if (isExist("waxed_oxidized_cut_copper")) {
			RegistryResult<Block> SMALL_WAXED_OXIDIZED_CUT_COPPER_STAIRS = registry.registerBlock(id("small_stairs_waxed_oxidized_cut_copper"), () -> Blocks.SMALL_WAXED_OXIDIZED_CUT_COPPER_STAIRS);
		...
		if (isExist("mud_bricks")) {
			RegistryResult<Block> SMALL_MUD_BRICK_STAIRS = registry.registerBlock(id("small_stairs_mud_bricks"), () -> Blocks.SMALL_MUD_BRICK_STAIRS);
		...
		if (isExist("bamboo_mosaic")) {
			RegistryResult<Block> SMALL_BAMBOO_MOSAIC_STAIRS = registry.registerBlock(id("small_stairs_bamboo_mosaic"), () -> Blocks.SMALL_BAMBOO_MOSAIC_STAIRS);
		...
		if (isExist("prismarine")) {
			RegistryResult<Block> SMALL_PRISMARINE_STAIRS = registry.registerBlock(id("small_stairs_prismarine"), () -> Blocks.SMALL_PRISMARINE_STAIRS);
		...
		if (isExist("prismarine_bricks")) {
			RegistryResult<Block> SMALL_PRISMARINE_BRICK_STAIRS = registry.registerBlock(id("small_stairs_prismarine_bricks"), () -> Blocks.SMALL_PRISMARINE_BRICK_STAIRS);
		...
		if (isExist("dark_prismarine")) {
			RegistryResult<Block> SMALL_DARK_PRISMARINE_STAIRS = registry.registerBlock(id("small_stairs_dark_prismarine"), () -> Blocks.SMALL_DARK_PRISMARINE_STAIRS);
		...
		if (isExist("smooth_sandstone")) {
			RegistryResult<Block> SMALL_SMOOTH_SANDSTONE_STAIRS = registry.registerBlock(id("small_stairs_smooth_sandstone"), () -> Blocks.SMALL_SMOOTH_SANDSTONE_STAIRS);
		...
		if (isExist("smooth_red_sandstone")) {
			RegistryResult<Block> SMALL_SMOOTH_RED_SANDSTONE_STAIRS = registry.registerBlock(id("small_stairs_smooth_red_sandstone"), () -> Blocks.SMALL_SMOOTH_RED_SANDSTONE_STAIRS);
		...
		if (isExist("smooth_quartz")) {
			RegistryResult<Block> SMALL_SMOOTH_QUARTZ_STAIRS = registry.registerBlock(id("small_stairs_smooth_quartz"), () -> Blocks.SMALL_SMOOTH_QUARTZ_STAIRS);
		...
		if (isExist("smooth_stone")) {
			RegistryResult<Block> SMALL_SMOOTH_STONE_STAIRS = registry.registerBlock(id("small_stairs_smooth_stone"), () -> Blocks.SMALL_SMOOTH_STONE_STAIRS);
		...
		if (isExist("mossy_cobblestone")) {
			RegistryResult<Block> SMALL_MOSSY_COBBLESTONE_STAIRS = registry.registerBlock(id("small_stairs_mossy_cobblestone"), () -> Blocks.SMALL_MOSSY_COBBLESTONE_STAIRS);
		...
		if (isExist("mossy_stone_bricks")) {
			RegistryResult<Block> SMALL_MOSSY_STONE_BRICK_STAIRS = registry.registerBlock(id("small_stairs_mossy_stone_bricks"), () -> Blocks.SMALL_MOSSY_STONE_BRICK_STAIRS);
		...
		if (isExist("end_stone_bricks")) {
			RegistryResult<Block> SMALL_END_STONE_BRICK_STAIRS = registry.registerBlock(id("small_stairs_end_stone_bricks"), () -> Blocks.SMALL_END_STONE_BRICK_STAIRS);
		...
		if (isExist("deepslate")) {
			RegistryResult<Block> SMALL_DEEPSLATE_STAIRS = registry.registerBlock(id("small_stairs_deepslate"), () -> Blocks.SMALL_DEEPSLATE_STAIRS);
		...
		if (isExist("deepslate_bricks")) {
			RegistryResult<Block> SMALL_DEEPSLATE_BRICK_STAIRS = registry.registerBlock(id("small_stairs_deepslate_bricks"), () -> Blocks.SMALL_DEEPSLATE_BRICK_STAIRS);
		...
		if (isExist("deepslate_tiles")) {
			RegistryResult<Block> SMALL_DEEPSLATE_TILE_STAIRS = registry.registerBlock(id("small_stairs_deepslate_tiles"), () -> Blocks.SMALL_DEEPSLATE_TILE_STAIRS);
		...
		if (isExist("polished_deepslate")) {
			RegistryResult<Block> SMALL_POLISHED_DEEPSLATE_STAIRS = registry.registerBlock(id("small_stairs_polished_deepslate"), () -> Blocks.SMALL_POLISHED_DEEPSLATE_STAIRS);
		...
		if (isExist("cobbled_deepslate")) {
			RegistryResult<Block> SMALL_COBBLED_DEEPSLATE_STAIRS = registry.registerBlock(id("small_stairs_cobbled_deepslate"), () -> Blocks.SMALL_COBBLED_DEEPSLATE_STAIRS);
		...
		if (isExist("blackstone")) {
			RegistryResult<Block> SMALL_BLACKSTONE_STAIRS = registry.registerBlock(id("small_stairs_blackstone"), () -> Blocks.SMALL_BLACKSTONE_STAIRS);
		...
		if (isExist("polished_blackstone")) {
			RegistryResult<Block> SMALL_POLISHED_BLACKSTONE_STAIRS = registry.registerBlock(id("small_stairs_polished_blackstone"), () -> Blocks.SMALL_POLISHED_BLACKSTONE_STAIRS);
		...
		if (isExist("polished_blackstone_bricks")) {
			RegistryResult<Block> SMALL_POLISHED_BLACKSTONE_BRICK_STAIRS = registry.registerBlock(id("small_stairs_polished_blackstone_bricks"), () -> Blocks.SMALL_POLISHED_BLACKSTONE_BRICK_STAIRS);
		...
		if (isExist("andesite")) {
			RegistryResult<Block> SMALL_ANDESITE_STAIRS = registry.registerBlock(id("small_stairs_andesite"), () -> Blocks.SMALL_ANDESITE_STAIRS);
		...
		if (isExist("diorite")) {
			RegistryResult<Block> SMALL_DIORITE_STAIRS = registry.registerBlock(id("small_stairs_diorite"), () -> Blocks.SMALL_DIORITE_STAIRS);
		...
		if (isExist("granite")) {
			RegistryResult<Block> SMALL_GRANITE_STAIRS = registry.registerBlock(id("small_stairs_granite"), () -> Blocks.SMALL_GRANITE_STAIRS);
		...
		if (isExist("polished_andesite")) {
			RegistryResult<Block> SMALL_POLISHED_ANDESITE_STAIRS = registry.registerBlock(id("small_stairs_polished_andesite"), () -> Blocks.SMALL_POLISHED_ANDESITE_STAIRS);
		...
		if (isExist("polished_diorite")) {
			RegistryResult<Block> SMALL_POLISHED_DIORITE_STAIRS = registry.registerBlock(id("small_stairs_polished_diorite"), () -> Blocks.SMALL_POLISHED_DIORITE_STAIRS);
